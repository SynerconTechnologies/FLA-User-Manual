...
to interact with the FLA in ways the front panel is not able to
support, such as previewing reports.
...
This page will give an overview of each pending data package. The value in the
OEM data column will be YES if the FLA was able to recover OEM
data for that download, and NO if the FLA could not. The yellow Archive button will
