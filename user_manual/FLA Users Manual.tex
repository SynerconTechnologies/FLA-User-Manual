...
\newcommand*{\titleGP}{\begingroup % Create the command for including the title page in the document
	...
	\textcopyright {\scshape 2016 v  } \\[0.3\baselineskip] % Year 
	\begin{center}
...
\item The FLA Preview Website
\item The FLA Portal Website
...
Furthermore, operators can use the FLA as an RP1210 compliang interface to allow the use manufacturers' software.
\begin{center}
...
\vspace{1cm}
The FLA Portal Webiste is hosted on Synercon Technologies' servers. It is accessed by the uniform resource locator (URL)  \url{https://fla.synercontechnologies.com}.
Data collected with the FLA is uploaded to this web site service so it can be preserved, verified, and displayed. Operators can veiw and print
view full Forensic  Link Adapter reports from the FLA Portal Website.
\vspace{1cm}
\begin{center}
