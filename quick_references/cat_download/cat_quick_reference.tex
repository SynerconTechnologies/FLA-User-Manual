...
\begin{figure}[tbph]
\centering
\includegraphics[width=.95\linewidth]{../../media/fla_site/main_page}
...
\begin{figure}[tbph]
\centering
\includegraphics[width=.95\linewidth]{../../media/fla_site/local_data}
\label{fig:fla_preview_local_data}
\end{figure}
\paragraph{  }
...
\paragraph{  }
The View Data button will allow the operator to view a preview of the report. This will contain all of the standards-based messages, as well as standards-based faults. For CAT ECMs, an abreviated part of the avaliable Quick-Stop records will show the speeds from two frames before the trigger to two frames after. The full records will be avaliable once the operator uploads the data to the Synercon Portal.
\paragraph{  }
